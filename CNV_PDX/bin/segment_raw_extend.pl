...
# This script adds to segment file the the arm fraction, LOH and CN diff and log ratio relative to 2 and ploidy
# The segments are extended

# nohup perl segment_raw_annotate.pl *segments_raw.txt *ploidy.txt hg19_chromosome_arm.txt gender.txt &
